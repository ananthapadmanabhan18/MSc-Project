...
char clusteringParametersTag [200] = "";
  
// Whether clusterizer should save images of individual segments  
bool clusteringSaveImages = false; 


// Whether clusterizer should run in 'calibration mode' in which raw signal from detector is saved. Used for determining calibration function and its parameters
...
char detectorGeometryFile[200] = "/home/apmnair18/Documents/MSc-Project/Simulation/GeometryFiles/geometry.txt"; // directory of geometry.txt
